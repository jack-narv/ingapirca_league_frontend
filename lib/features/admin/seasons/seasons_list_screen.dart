...
class SeasonsListScreen extends StatefulWidget {
  ...
  @override
  State<SeasonsListScreen> createState() =>
      _SeasonsListScreenState();
}

class _SeasonsListScreenState
    extends State<SeasonsListScreen> {
  ...
  void initState() {
    super.initState();
    _seasonsFuture =
        _service.getByLeague(widget.league.id);
  }
